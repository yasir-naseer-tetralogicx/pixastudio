...
<head>
    ...
    <title><?php echo e(config('shopify-app.app_name')); ?> &mdash; Login</title>
...
<body>
    <main class="container" role="main">
        <h3 class="title">
            <?php echo e(config('shopify-app.app_name')); ?>

        </h3>

        <?php if(session()->has('error')): ?>
            <div class="error">
                <strong>Oops! An error has occured:</strong> <?php echo e(session('error')); ?>
...
<?php /**PATH /home/176572.cloudwaysapps.com/vpjnvrwpkw/public_html/vendor/osiset/laravel-shopify/src/ShopifyApp/resources/views/auth/index.blade.php ENDPATH**/ ?>